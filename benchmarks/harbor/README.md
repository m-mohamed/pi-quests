...
When Harbor integrity fails, preflight now includes the issue codes and matched source snippets that triggered the fail-closed decision. Treat that as an upstream trust blocker, not a local smoke failure.
