...
- Legacy benchmark stacks are no longer supported in this repo.
- Trials now optimize against eval families, not benchmark families.
...
- Local legacy trial artifacts from removed benchmark families are ignored by the runtime.
